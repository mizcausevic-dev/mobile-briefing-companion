...
### Released
- Released **mobile-briefing-companion** publicly as a reviewable operating system for platform governance.
...
### Shipped
- Cut the first coherent internal version of **mobile-briefing-companion** with stable domain objects, review surfaces, and decision outputs.
